    ...
    <main className="min-h-screen">
      ...
      <section className="bg-muted py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-10">{t("teamStats")}</h2>
          ...
          <Link href="/matches">
            <Button size="lg" className="bg-green-700 hover:bg-green-800 text-white rounded-2xl shadow-lg">{t("matchresults")}</Button>
          </Link>
        </div>
      </section>
